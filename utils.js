...
const PACKAGE_FILE = /package(-lock)?\.json|yarn.lock/g;
 ...
 */
exports.getPackageFiles = (diffTree = "") =>
 ...
 * @param {String[]}
 */
exports.getDirectoriesToInstall = (files = []) =>
  Array.isArray(files)
    ? exports.unique(files.map((file) => dirname(file)))
    : [];
